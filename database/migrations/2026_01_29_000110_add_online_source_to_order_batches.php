    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            Schema::create('order_batches_new', function (Blueprint $table) {
                ...
                $table->enum('source', ['server', 'table', 'pos', 'online'])->default('server');
        ...
        DB::statement(
            "ALTER TABLE order_batches MODIFY source ENUM('server','table','pos','online') NOT NULL DEFAULT 'server'"
        );
    }
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement('
                INSERT INTO order_batches_new (id, order_id, source, status, confirmed_at, cancelled_at, created_at, updated_at)
                SELECT id, order_id,
                    CASE WHEN source = "online" THEN "server" ELSE source END,
